...
export const INITIAL_PRODUCTIVITY_LOGS: ProductivityLog[] = [
  {
    ...
    callsClosed: 5,
    accessories: [
      { skuId: 'SKU-001', qty: 2, saleValue: 900 },
      { skuId: 'SKU-003', qty: 1, saleValue: 380 },
    ],
    rcpCollected: 3000,
    status: 'Approved',
    tlNote: 'Great start of month',
    adminNote: 'Approved by admin',
    validatedBy: 'leader@fieldops.com',
  },
  {
    id: 'PL-002',
    engEmail: 'eng01@fieldops.com',
    ...
    callsClosed: 4,
    accessories: [
      { skuId: 'SKU-002', qty: 1, saleValue: 550 },
    ],
    rcpCollected: 1500,
    status: 'Approved',
    tlNote: 'Looks fine',
    adminNote: 'System auto approved',
    validatedBy: 'leader@fieldops.com',
  },
  {
    id: 'PL-003',
    ...
    callsClosed: 6,
    accessories: [
      { skuId: 'SKU-004', qty: 1, saleValue: 650 },
    ],
    rcpCollected: 4000,
    status: 'Approved',
    tlNote: 'Accurate',
